...
if __name__ == "__main__":
    ...
    for layer in data.keys():
        ...
        # for i in range(num_timesteps):    # print(data[layer].shape)
            visualize_attn(data[layer], token = 2, output_dir=f'./outputs/last_attn/',output_name= f'{layer}.jpg')
